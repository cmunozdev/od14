...
class PayrollStructure(models.Model):
    ...
    def fill_rule_structure(self):
        ...
        struct_f_id = self.env.ref('domi_hhrr.structure_permanent_employees').id
        struct_c_id = self.env.ref('domi_hhrr.christmas_salary_structure').id
        struct_ex_id = self.env.ref('domi_hhrr.structure_foreign_employees').id
